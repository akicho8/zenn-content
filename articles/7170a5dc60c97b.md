...
いつのまにか [Ruby/SDL2](https://rubygems.org/gems/ruby-sdl2/versions/0.1.0?locale=ja) が公開されていたので誰も関心はないと思いますが導入の手順を紹介します。
...
テキスト表示するだけでこんなに書かないといけないのかって感じですが自分に合った使いやすいメソッドにしてしまえば問題ないでしょう。

左上にカウンタと秒間フレーム数が表示できました。
