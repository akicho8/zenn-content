...
[nannou](https://docs.rs/nannou) で使われているベクトルライブラリ [glam](https://docs.rs/glam) の作り込みがやばかったので、2Dを扱うときに便利な f32 の成分を持つ Vec2 型を中心に(自分が使い方を覚えるために)おおまかに紹介していきます。
...
ついでに書いちゃうと Ruby の標準ベクトルライブラリは使い勝手がいまいちだった。
...
型に優しく使い手の意図を汲み取るのが上手な Ruby なのに Rust より厳しいのだった。
