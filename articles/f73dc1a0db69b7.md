...
# テキストは曖昧一致より完全一致の方に寄せていく

曖昧一致が初期値になっているのがよくない
次のように書いてしまうと「送信」は部分一致なので、そのときは動くかもしれないけどのちのち動かなくなる場合がある
また部分一致なせいでどこの「送信」のことを指しているのか自分自身がわからなくなり、メンテナンスが難しくなる
