...
## 縦に長いフォームでいちばん下までスクロールしたら一番上のテキストフィールドが選択できなくなった

- 盲点になりがち
- 他の div に覆われているとかではなく、スクロールして単に見えなくなった部分は選択できない
- このときのエラー → `Unable to find visible css "#xxx`
- `visible: :all` をつけると選択できる
