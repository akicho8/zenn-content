...
```
  ...
  * オプションとコマンドをどこに書くか決まりはない
    * 見てわかるように配列要素の3つ目が関数かどうかで見分けているっぽい
    * だからオプション類は下に配置してもいい
...
となるので、オプションの配列 `(transient-args 'f1)` を渡せばよい
...
仮に最初につくった方と混ぜたすると `l` が両方にあるため干渉してしまう
