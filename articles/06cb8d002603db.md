...
transient.el は Magit で使われているメニュー表示用のUIライブラリです
Magit は Emacs から Git を簡単に扱うUIライブラリです
...
次の固定幅フォント使うオプションを有効にしても回避できるけど、文字に隙間が空いて古めかしい感じの見た目になってしまうので、上ので十分だと思う
