...
v.len()  // => 2
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.len) 
...
```
クロージャは渡せない
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.count) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.counts) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.counts_by) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.all_equal) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.all_unique) 
...
c // => [3, 6, 9]
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.multiunzip) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.get) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.next_tuple) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.collect_tuple) 
...
[5, 6, 7].first() // => Some(5)
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.first) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.take) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.dropping_back) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.take_while) 
...
[5, 6, 7].last() // => Some(7)
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.last) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.last) 
...
v  // => []
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.clear) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.is_empty) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.dropping) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.split_off) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.skip) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.skip_while) 
...
v  // => [5, 6, 7, 8, 9]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.split_at) 
...
v  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.push) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.append) 
...
v        // => [5, 6]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.pop) 
...
v               // => [6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.take_first) 
...
v              // => [5, 6]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.take_last) 
...
```
insert で代用しよう
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.insert) 
...
v  // => [6, 7, 5]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.rotate_left) 
...
v  // => [7, 5, 6]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.rotate_right) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.rev) 
...
```
破壊しないのが欲しかった
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.reverse) 
...
v  // => [8, 8, 8]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.fill) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.fill_with) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.pad_using) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.repeat) 
...
```
前に詰めるので最悪 O(n) かかる
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.remove) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.swap_remove) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.map) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.flat_map) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.update) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.map_into) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.scan) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.filter) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.filter_map) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.map_while) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.find_map) 
...
```
retain の意味は「保持」
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.retain) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.retain_mut) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.unique) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.unique_by) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.all) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.any) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.at_most_one) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.find) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.find_or_first) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.find_or_last) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.position) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.rposition) 
...
```
値も返す
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.find_position) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.fold) 
...
sum // => None
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.try_fold) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.reduce) 
...
r // => None
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.try_reduce) 
...
[].iter().sum::<isize>()         // => 0
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.sum) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.sum1) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.product) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.product1) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.max) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.max_by_key) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.max_by) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.position_max) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.minmax) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.position_minmax) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.iter) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.collect) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.collect_vec) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.for_each) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.try_for_each) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.enumerate) 
...
```
お気に入り
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.with_position) 
...
```
1つずつ要素が来るので注意
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.inspect) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.step_by) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.zip) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.interleave) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.zip_longest) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.interleave_shortest) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.combinations) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.permutations) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.powerset) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.windows) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#tuple_windows) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#circular_tuple_windows) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#tuples) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.group_by) 
...
odd   // => [5, 7]
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.partition) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.partition_map) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.partition_result) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.partition_in_place) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.is_partitioned) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.chunks) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.rchunks) 
...
```
split の類似
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.split) 
...
```
境界の値を含める版
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.split_inclusive) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.rsplit) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.splitn) 
...
```
splitn の末尾から版
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.rsplitn) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.starts_with) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.ends_with) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.strip_prefix) 
...
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.strip_suffix) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.take) 
...
v.to_vec()  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.to_vec) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.join) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.format_with) 
...
```
実行順番がよくわからない
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.format) 
...
["a", "b", "c"].join("-")         // => "a-b-c"
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.join) 
...
```
文字列の配列だと join になる
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.concat) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.flatten) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.sorted) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.sorted_by) 
...
v  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_by) 
...
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.sorted_by_key) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_by_key) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.sorted_by_cached_key) 
...
v  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_by_cached_key) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_unstable) 
...
v  // => [5, 6, 7, 8]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_unstable_by) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.sort_unstable_by_key) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.binary_search) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.binary_search_by) 

## `?` → `binary_search_by_key`
```rust:Rust
[(0, 5), (0, 7), (0, 9)].binary_search_by_key(&7, |&(_, e)| e)  // => Ok(1)
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.binary_search_by_key) 
...
```
連続する値を1つにする
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.dedup) 
...
```
クロージャ付きの dedup
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.dedup_by_key) 
...
```
クロージャに引数が2つ来る dedup
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.dedup_by) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.partition_dedup) 
...
v  // => [65, 66, 67, 68]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.make_ascii_uppercase) 
...
v  // => [97, 98, 99, 100]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.make_ascii_lowercase) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.is_ascii) 
...
```
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.k_smallest) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.cmp) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.cmp_by) 
...
```
Some でラップしてある
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.partial_cmp) 
...
```
Some でラップしてある
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.partial_cmp_by) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.intersperse) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.intersperse_with) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.chain) 
...
it.next() // => None
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#tymethod.next) 
...
[DOC](https://doc.rust-lang.org/std/iter/struct.Peekable.html#method.peek) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.nth) 
...
it.next()        // => Some(7)
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.advance_by) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.fuse) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.size_hint) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.eq) 
...
```
これは使いづらい
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.eq_by) 
...
```
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.is_sorted) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.is_sorted) 

## `?` → `is_sorted_by`
```rust:Rust (nightly)
[5, 6, 7].is_sorted_by(|a, b| a.partial_cmp(b))  // => true
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.is_sorted_by) 

## `?` → `is_sorted_by_key`
```rust:Rust (nightly)
[5_isize, -6, 7].is_sorted_by_key(|e| e.abs())  // => true
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.is_sorted_by_key) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.is_sorted_by) 
...
[DOC](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.is_sorted_by_key) 
...
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.select_nth_unstable) 
...
v  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.select_nth_unstable_by) 
...
v  // => [5, 6, 7]
```
[DOC](https://doc.rust-lang.org/std/vec/struct.Vec.html#method.select_nth_unstable_by_key) 
...
```
使いどころがわからないメソッド
[DOC](https://docs.rs/itertools/latest/itertools/trait.Itertools.html#method.tee) 
